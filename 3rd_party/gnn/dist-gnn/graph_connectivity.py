...
def update_global_ids(
    data_full: Data, data_reduced: Data, idx_full2reduced: Tensor
) -> Data:
    """
...
def get_upsample_indices(
    ...
    """
    # Make all global IDs unique so coincident nodes share the same ID
...
def upsample_node_attributes(
    x_reduced: Tensor,
    gid_reduced: Tensor,
    lid_reduced: Tensor,
    gid_full: Tensor,
    lid_full: Tensor,
    idx_reduced2full: Tensor,
) -> Tensor:
    """
