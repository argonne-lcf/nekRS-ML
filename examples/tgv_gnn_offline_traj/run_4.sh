...
# Run nekRS
#mpiexec -n 4 -ppn 4 --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 -- /home/balin/.local/nekrs/bin/nekrs --setup tgv --backend dpcpp

# Generate the halo_info, edge_weights and node_degree files
#mpiexec -n 4 -ppn 4 --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 python /home/balin/.local/nekrs/3rd_party/gnn/dist-gnn/create_halo_info_par.py --POLY 7 --PATH ./gnn_outputs_poly_7
...
mpiexec -n 4 -ppn 4 --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 python ../../3rd_party/gnn/dist-gnn/main.py master_addr=$head_node halo_swap_mode=all_to_all_opt layer_norm=True gnn_outputs_path=/flare/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline_traj/gnn_outputs_poly_7_4 traj_data_path=/flare/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline_traj/traj_poly_7_4/tinit_0.000000_dtfactor_10 time_dependency=time_dependent target_loss=6.9031e-01 transform_x=true transform_y=true transform_z=true
