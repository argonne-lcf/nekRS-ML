...
source /tegu/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline_traj/../_env_dist-gnn_posix/bin/activate
module list
...
mpiexec -n $RANKS -ppn $RANKS --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 python /home/balin/.local/nekrs//3rd_party/gnn/dist-gnn/create_halo_info_par.py --POLY 7 --PATH ./gnn_outputs_poly_7_$RANKS
...
mpiexec -n $RANKS -ppn $RANKS --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 python /home/balin/.local/nekrs//3rd_party/gnn/dist-gnn/main.py master_addr=$head_node halo_swap_mode=all_to_all_opt layer_norm=True gnn_outputs_path=/tegu/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline_traj/gnn_outputs_poly_7_$RANKS traj_data_path=/tegu/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline_traj/traj_poly_7_${RANKS}/tinit_0.000000_dtfactor_10 time_dependency=time_dependent target_loss=6.6139e-01 transform_x=true transform_y=true transform_z=true
