...
# Train the GNN
mpirun -n $RANKS python ../../3rd_party/gnn/dist-gnn/main.py phase1_steps=10 master_addr=127.0.0.1 halo_swap_mode=all_to_all layer_norm=True gnn_outputs_path=./gnn_outputs_poly_7_$RANKS traj_data_path=./traj_poly_7_${RANKS}/tinit_0.000000_dtfactor_10 time_dependency=time_dependent target_loss=8.904e-01 transform_x=true transform_y=true transform_z=true
