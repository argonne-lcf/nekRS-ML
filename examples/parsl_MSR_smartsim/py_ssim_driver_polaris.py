...
@python_app
def hello_affinity(args,launcher,SSDB,simNodes,exp):
    import os
    import sys
    from argparse import ArgumentParser
    import numpy as np
...
#        t.result()
    ...
    tasks = []
    for i in range(1):
        tasks.append(hello_affinity(args,launcher,SSDB,simNodes,exp))

    # Wait for all apps to finish and collect the results
    outputs = [i.result() for i in tasks]
    # Print results
#    print(outputs)
