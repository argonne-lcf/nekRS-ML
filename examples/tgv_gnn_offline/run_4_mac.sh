...
# Train the GNN
mpirun -n $RANKS python ../../3rd_party/gnn/dist-gnn/main.py master_addr=127.0.0.1 halo_swap_mode=all_to_all layer_norm=True gnn_outputs_path=./gnn_outputs_poly_3_$RANKS target_loss=2.716e-04 phase1_steps=100 n_messagePassing_layers=4 transform_x=true transform_y=true transform_z=true
