...
source /tegu/datascience/balin/Nek/nekRS-ML/nekRS-ML/examples/tgv_gnn_offline/../_env_dist-gnn_posix/bin/activate
module list
...
#mpiexec -n $RANKS -ppn $RANKS --cpu-bind=list:1:8:16:24:32:40:53:60:68:76:84:92 python /home/balin/.local/nekrs//3rd_party/gnn/dist-gnn/create_halo_info_par.py --POLY 3 --PATH ./gnn_outputs_poly_3_$RANKS
