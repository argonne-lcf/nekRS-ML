...
# required to call nekRS C functions from nek
set(UNDEFINED_FLAG "-Wl,--allow-shlib-undefined")
if(APPLE)
  set(UNDEFINED_FLAG "-Wl,-undefined dynamic_lookup")
endif()
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND
    ...
    "FFLAGS=${_EXTERNAL_Fortran_FLAGS} ${FPIC_FLAG} ${MCMODEL_FLAG} ${LARGE_DATA_THRES_FLAG}"
